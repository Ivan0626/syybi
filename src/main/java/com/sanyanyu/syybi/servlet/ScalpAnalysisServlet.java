	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ("searchB".equals(m)) {// 飚量店铺搜索
			...
			try {
				...
				PageEntity<GoodsList> pageEntity = scalpService.getPageShopList(pageParam, shopId, category, prdName,
						adType);
			...
			try {
				...
				PageEntity<AdAnalysis> pageEntity = scalpService.getPageAdList(pageParam, shopId, startDate, endDate);
