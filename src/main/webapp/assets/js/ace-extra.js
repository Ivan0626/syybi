...
ace.cookie = {
	...
	get : function(name) {
		...
		e = cookie.indexOf(";", b);//stringObject.indexOf(searchvalue,fromindex)

		if ( e == -1 )
			e = cookie.length;

		return decodeURIComponent( cookie.substring(b + p.length, e) );//stringObject.substring(start,stop)
	},
