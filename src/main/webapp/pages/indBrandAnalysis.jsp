			...
			<div class="col-sm-12">
				...
				<div class="tabbable">
					<ul class="nav nav-tabs" id="myTab">
						<li class="active">
							<a data-toggle="tab" id="tab1" href="#scaleBrand">
						...
						<li>
							<a data-toggle="tab" id="tab2" href="#trendBrand">
								<i class="green ace-icon fa fa-home bigger-120"></i>
								各品牌趋势
							</a>
						</li>
					...
					<div class="tab-content">
						<div id="scaleBrand" class="tab-pane fade in active">
							<div class="row">
								<div class="col-sm-12">
						...
						<div id="trendBrand" class="tab-pane fade">
							<div class="row">
								<div class="col-sm-12">
									<div class="widget-box">
										<div class="widget-header">
...
<script src="../assets/js/indBrandAnalysis.js"></script>
