...
<body>
						...
						<div class="col-sm-12">
							...
							<div class="tabbable">
								<ul class="nav nav-tabs" id="myTab">
									<li class="active">
										<a data-toggle="tab" id="tab1" href="#ad">
									...
									<li>
										<a data-toggle="tab" id="tab2" href="#gen">
											<i class="green ace-icon fa fa-home bigger-120"></i>
											宝贝跟踪
										</a>
									</li>
													...
													<div class="widget-body">
														...
														<div class="widget-main">
															<div class="widget-elem">
																...
																<select id="adType" style="margin-left: 50px;">
															...
															<div class="widget-elem">
																...
																<input style="margin-left: 80px;padding: 0 0;height:auto;" size="15" type="text" value="<%=DateUtils.getLastMonthDate() %>" class="Wdate" id="d43211" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-{%d-60}',maxDate:'#F{$dp.$D(\'d43222\')||\'%y-%M-%d\'}'})"/>
																到
																<input style="padding: 0 0;height:auto;" size="15" type="text" class="Wdate" value="<%=DateUtils.getDate() %>" id="d43222" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'d43211\')||\'%y-%M-{%d-60}\';}',maxDate:'%y-%M-%d'})"/>
															</div>
													...
													<div class="widget-body">
														...
														<div class="widget-main">
															...
															<div class="widget-elem">
																...
																<label style="margin-left: 50px;">
																	<input name="priceChartType" type="radio" value="1" class="ace" />
																	<span class="lbl"> 图表</span>
																</label>
																<label>
																	<input name="priceChartType" type="radio" value="2" class="ace" checked />
																	<span class="lbl"> 数据表</span>
																</label>
															</div>
	...
	<script src="../assets/js/goodsDetail.js"></script>
