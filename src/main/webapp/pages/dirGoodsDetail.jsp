...
<body>
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li><a href="${ctx }/a/GoodsAnalysis?m=goods_list&adid=${param.adid }&dirName=<%=URLEncoder.encode(request.getParameter("dirName"), "utf-8") %>&tab=tab1">宝贝列表</a></li>
	...
	<script src="../assets/js/dirGoodsDetail.js"></script>
